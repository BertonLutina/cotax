                                ...
                                <div className="flex items-start gap-x-3">
                                  ...
                                  <div
                                    className={classNames(
                                      `rounded-md ${transaction.status === "Payée" ? "bg-green-50 text-green-700 ring-green-600/20" : "bg-red-50 text-red-700 ring-red-600/20"} px-2 py-1 text-xs font-medium ring-1 ring-inset`
                                    )}
                                  >
                                    {transaction.status}
                                  </div>
