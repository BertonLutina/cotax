...
const DesktopSidebar = ({client = 1}) => {
  ...
  return (
    ...
    <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 dark:border-white/10 dark:bg-neutral-200">
      ...
      <nav className="flex flex-1 flex-col">
        <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    <li onClick={()=> changePage(item)} key={item.name}>
                      ...
                      >
                        <item.icon
                          aria-hidden="true"
                          className={classNames(
                            item.name === selectedItem?.name                              ? 'text-blue-950'
          ...
          <li className="-mx-6 mt-auto">
            <a
              href="#"
              className="flex items-center gap-x-4 px-6 py-3 text-sm/6 font-semibold text-blue-900 hover:bg-gray-50 dark:text-neutral-900 dark:hover:bg-white/5"
            >
              <img
                alt=""
              ...
              <span aria-hidden="true">Thomas Lusakala</span>
            </a>
          </li>
        </ul>
      </nav>
